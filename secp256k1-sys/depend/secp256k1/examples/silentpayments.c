 ...
 *
 *      rustsecp256k1_v0_10_0_silentpayments_recipient_scan_outputs(..., NULL, NULL);
 */
...
int main(void) {
    ...
    rustsecp256k1_v0_10_0_xonly_pubkey tx_inputs[N_INPUTS];
    const rustsecp256k1_v0_10_0_xonly_pubkey *tx_input_ptrs[N_INPUTS];
    rustsecp256k1_v0_10_0_xonly_pubkey tx_outputs[N_OUTPUTS];
    rustsecp256k1_v0_10_0_xonly_pubkey *tx_output_ptrs[N_OUTPUTS];
    rustsecp256k1_v0_10_0_silentpayments_found_output found_outputs[N_OUTPUTS];
    rustsecp256k1_v0_10_0_silentpayments_found_output *found_output_ptrs[N_OUTPUTS];
    rustsecp256k1_v0_10_0_silentpayments_prevouts_summary prevouts_summary;
    rustsecp256k1_v0_10_0_pubkey unlabeled_spend_pubkey;
    ...
    rustsecp256k1_v0_10_0_context* ctx = rustsecp256k1_v0_10_0_context_create(SECP256K1_CONTEXT_NONE);
    if (!fill_random(randomize, sizeof(randomize))) {
        printf("Failed to generate randomness\n");
        return EXIT_FAILURE;
    }
    /* Randomizing the context is recommended to protect against side-channel
     * leakage. See `rustsecp256k1_v0_10_0_context_randomize` in secp256k1.h for more
     * information about it. This should never fail. */
    ret = rustsecp256k1_v0_10_0_context_randomize(ctx, randomize);
    assert(ret);
    ...
    {
        size_t len = 33;
        rustsecp256k1_v0_10_0_pubkey label, labeled_spend_pubkey;
        unsigned int m = 1;

        /* Load Bob's spend public key */
        ret = rustsecp256k1_v0_10_0_ec_pubkey_parse(ctx,
         ...
         */
        ret = rustsecp256k1_v0_10_0_silentpayments_recipient_create_label(ctx,
            &label,
        ...
        ret = rustsecp256k1_v0_10_0_ec_pubkey_serialize(ctx,
         ...
         */
        ret = rustsecp256k1_v0_10_0_silentpayments_recipient_create_labeled_spend_pubkey(ctx, &labeled_spend_pubkey, &unlabeled_spend_pubkey, &label);
        assert(ret);
    ...
    /*** Sending (Alice) ***/
    {
        rustsecp256k1_v0_10_0_keypair sender_keypairs[N_INPUTS];
        const rustsecp256k1_v0_10_0_keypair *sender_keypair_ptrs[N_INPUTS];
        rustsecp256k1_v0_10_0_silentpayments_recipient recipients[N_OUTPUTS];
        const rustsecp256k1_v0_10_0_silentpayments_recipient *recipient_ptrs[N_OUTPUTS];
        ...
        for (i = 0; i < N_INPUTS; i++) {
            ...
            if (rustsecp256k1_v0_10_0_keypair_create(ctx, &sender_keypairs[i], seckey)) {
                sender_keypair_ptrs[i] = &sender_keypairs[i];
                ret = rustsecp256k1_v0_10_0_keypair_xonly_pub(
                    ctx,
                    &tx_inputs[i],
                    NULL,
                    &sender_keypairs[i]
        ...
        for (i = 0; i < N_OUTPUTS; i++) {
            printf("    ");
            ret = rustsecp256k1_v0_10_0_xonly_pubkey_serialize(ctx,
                serialized_xonly,
                &tx_outputs[i]
            );
            assert(ret);
    ...
    /*** Receiving ***/
    {
        unsigned char light_client_data33[33];
        {
             ...
             *        `rustsecp256k1_v0_10_0_silentpayments_recipient_prevouts_summary_create`
             *     2. Call `rustsecp256k1_v0_10_0_silentpayments_recipient_scan_outputs`
             *
             * Bob collects the prevouts data from the transaction inputs and
             * creates a `rustsecp256k1_v0_10_0_silentpayments_prevouts_summary` object. He uses
             ...
             * with light clients.
             */
            ret = rustsecp256k1_v0_10_0_silentpayments_recipient_prevouts_summary_create(ctx,
                &prevouts_summary,
                smallest_outpoint,
            ...
            ret = rustsecp256k1_v0_10_0_silentpayments_recipient_prevouts_summary_serialize(ctx,
                light_client_data33,
                33,
                &prevouts_summary,
                SECP256K1_EC_COMPRESSED
            ...
            found = 0;
            n_found_outputs = 0;
            ret = rustsecp256k1_v0_10_0_silentpayments_recipient_scan_outputs(ctx,
                found_output_ptrs, &n_found_outputs,
                (const rustsecp256k1_v0_10_0_xonly_pubkey * const *)tx_output_ptrs, N_OUTPUTS,
                bob_scan_key,
                &prevouts_summary,
                &unlabeled_spend_pubkey,
            ...
            if (n_found_outputs > 0) {
                rustsecp256k1_v0_10_0_keypair kp;
                ...
                for (i = 0; i < n_found_outputs; i++) {
                     ...
                     * been added to the tweak in `rustsecp256k1_v0_10_0_silentpayments_found_output`.
                     *
                    ...
                    ret = rustsecp256k1_v0_10_0_ec_seckey_tweak_add(ctx, full_seckey, found_outputs[i].tweak);
                    ret &= rustsecp256k1_v0_10_0_keypair_create(ctx, &kp, full_seckey);
                    ret &= rustsecp256k1_v0_10_0_keypair_xonly_pub(
                        ctx,
                        &xonly_output,
                        NULL,
                     ...
                     */
                    assert(ret);
                    assert(rustsecp256k1_v0_10_0_xonly_pubkey_cmp(ctx, &xonly_output, &found_outputs[i].output) == 0);
        ...
        }
        {
             ...
             * `rustsecp256k1_v0_10_0_silentpayments_recipient_scan_outputs` to find all of
            ...
            ret = rustsecp256k1_v0_10_0_silentpayments_recipient_prevouts_summary_parse(ctx,
                &prevouts_summary,
                light_client_data33,
                33
            );
            ...
            n_found_outputs = 0;
            {
                rustsecp256k1_v0_10_0_xonly_pubkey *potential_output_ptrs[1];
                rustsecp256k1_v0_10_0_xonly_pubkey potential_outputs[1];
                ...
                ret = rustsecp256k1_v0_10_0_silentpayments_recipient_create_output_pubkeys(ctx,
                ...
                found = 0;
                for (i = 0; i < N_OUTPUTS; i++) {
                    if (rustsecp256k1_v0_10_0_xonly_pubkey_cmp(ctx, &potential_outputs[0], &tx_outputs[i]) == 0) {
                        found = 1;
                        break;
                    }
                }
