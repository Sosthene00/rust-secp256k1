 ...
 */
static void rustsecp256k1_v0_10_0_scalar_split_lambda(rustsecp256k1_v0_10_0_scalar * SECP256K1_RESTRICT r1, rustsecp256k1_v0_10_0_scalar * SECP256K1_RESTRICT r2, const rustsecp256k1_v0_10_0_scalar * SECP256K1_RESTRICT k) {
...
#ifdef VERIFY
static void rustsecp256k1_v0_10_0_scalar_split_lambda_verify(const rustsecp256k1_v0_10_0_scalar *r1, const rustsecp256k1_v0_10_0_scalar *r2, const rustsecp256k1_v0_10_0_scalar *k);
#endif
...
static void rustsecp256k1_v0_10_0_scalar_split_lambda(rustsecp256k1_v0_10_0_scalar * SECP256K1_RESTRICT r1, rustsecp256k1_v0_10_0_scalar * SECP256K1_RESTRICT r2, const rustsecp256k1_v0_10_0_scalar * SECP256K1_RESTRICT k) {
    ...
    SECP256K1_SCALAR_VERIFY(r2);
#ifdef VERIFY
    rustsecp256k1_v0_10_0_scalar_split_lambda_verify(r1, r2, k);
#endif
}

#ifdef VERIFY
/*
 * Proof for rustsecp256k1_v0_10_0_scalar_split_lambda's bounds.
 *
 * Let
...
static void rustsecp256k1_v0_10_0_scalar_split_lambda_verify(const rustsecp256k1_v0_10_0_scalar *r1, const rustsecp256k1_v0_10_0_scalar *r2, const rustsecp256k1_v0_10_0_scalar *k) {
    ...
    rustsecp256k1_v0_10_0_scalar_mul(&s, &rustsecp256k1_v0_10_0_const_lambda, r2);
    rustsecp256k1_v0_10_0_scalar_add(&s, &s, r1);
    VERIFY_CHECK(rustsecp256k1_v0_10_0_scalar_eq(&s, k));

    rustsecp256k1_v0_10_0_scalar_negate(&s, r1);
    rustsecp256k1_v0_10_0_scalar_get_b32(buf1, r1);
    rustsecp256k1_v0_10_0_scalar_get_b32(buf2, &s);
    VERIFY_CHECK(rustsecp256k1_v0_10_0_memcmp_var(buf1, k1_bound, 32) < 0 || rustsecp256k1_v0_10_0_memcmp_var(buf2, k1_bound, 32) < 0);

    rustsecp256k1_v0_10_0_scalar_negate(&s, r2);
    rustsecp256k1_v0_10_0_scalar_get_b32(buf1, r2);
    rustsecp256k1_v0_10_0_scalar_get_b32(buf2, &s);
    VERIFY_CHECK(rustsecp256k1_v0_10_0_memcmp_var(buf1, k2_bound, 32) < 0 || rustsecp256k1_v0_10_0_memcmp_var(buf2, k2_bound, 32) < 0);
}
#endif /* VERIFY */
