...
static void run_nonce_function_bip340_tests(void) {
    ...
    rustsecp256k1_v0_10_0_sha256 sha_optimized;
     ...
     * rustsecp256k1_v0_10_0_nonce_function_bip340_sha256_tagged has the expected
     * state. */
    rustsecp256k1_v0_10_0_nonce_function_bip340_sha256_tagged(&sha_optimized);
    test_sha256_tag_midstate(&sha_optimized, tag, sizeof(tag));


   /* Check that hash initialized by
    * rustsecp256k1_v0_10_0_nonce_function_bip340_sha256_tagged_aux has the expected
    * state. */
    ...
    CHECK(nonce_function_bip340(nonce, msg, msglen, key, pk, algo, algolen, NULL) == 1);
    CHECK(rustsecp256k1_v0_10_0_memcmp_var(nonce_z, nonce, 32) == 0);
}
...
static void test_schnorrsig_api(void) {
    ...
    unsigned char msg[32];
    rustsecp256k1_v0_10_0_keypair keypairs[3];
    rustsecp256k1_v0_10_0_keypair invalid_keypair = {{ 0 }};
    rustsecp256k1_v0_10_0_xonly_pubkey pk[3];
    rustsecp256k1_v0_10_0_xonly_pubkey zero_pk;
    ...
    CHECK(rustsecp256k1_v0_10_0_keypair_xonly_pub(CTX, &pk[0], NULL, &keypairs[0]) == 1);
    CHECK(rustsecp256k1_v0_10_0_keypair_xonly_pub(CTX, &pk[1], NULL, &keypairs[1]) == 1);
    CHECK(rustsecp256k1_v0_10_0_keypair_xonly_pub(CTX, &pk[2], NULL, &keypairs[2]) == 1);
    memset(&zero_pk, 0, sizeof(zero_pk));

    /** main test body **/
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign32(CTX, sig, msg, &keypairs[0], NULL) == 1);
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_sign32(CTX, NULL, msg, &keypairs[0], NULL));
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_sign32(CTX, sig, NULL, &keypairs[0], NULL));
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_sign32(CTX, sig, msg, NULL, NULL));
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_sign32(CTX, sig, msg, &invalid_keypair, NULL));
    CHECK_ILLEGAL(STATIC_CTX, rustsecp256k1_v0_10_0_schnorrsig_sign32(STATIC_CTX, sig, msg, &keypairs[0], NULL));

    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypairs[0], &extraparams) == 1);
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, NULL, msg, sizeof(msg), &keypairs[0], &extraparams));
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, NULL, sizeof(msg), &keypairs[0], &extraparams));
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, NULL, 0, &keypairs[0], &extraparams) == 1);
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), NULL, &extraparams));
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &invalid_keypair, &extraparams));
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypairs[0], NULL) == 1);
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypairs[0], &invalid_extraparams));
    CHECK_ILLEGAL(STATIC_CTX, rustsecp256k1_v0_10_0_schnorrsig_sign_custom(STATIC_CTX, sig, msg, sizeof(msg), &keypairs[0], &extraparams));

    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign32(CTX, sig, msg, &keypairs[0], NULL) == 1);
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &pk[0]) == 1);
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, NULL, msg, sizeof(msg), &pk[0]));
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig, NULL, sizeof(msg), &pk[0]));
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig, NULL, 0, &pk[0]) == 0);
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig, msg, sizeof(msg), NULL));
    CHECK_ILLEGAL(CTX, rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &zero_pk));
}

/* Checks that hash initialized by rustsecp256k1_v0_10_0_schnorrsig_sha256_tagged has the
 * expected state. */
static void test_schnorrsig_sha256_tagged(void) {
    ...
    rustsecp256k1_v0_10_0_sha256_initialize_tagged(&sha, (unsigned char *) tag, sizeof(tag));
    rustsecp256k1_v0_10_0_schnorrsig_sha256_tagged(&sha_optimized);
...
static void test_schnorrsig_bip_vectors_check_signing(const unsigned char *sk, const unsigned char *pk_serialized, const unsigned char *aux_rand, const unsigned char *msg, size_t msglen, const unsigned char *expected_sig) {
    ...
    rustsecp256k1_v0_10_0_xonly_pubkey pk, pk_expected;

    rustsecp256k1_v0_10_0_schnorrsig_extraparams extraparams = SECP256K1_SCHNORRSIG_EXTRAPARAMS_INIT;
    extraparams.ndata = (unsigned char*)aux_rand;

    CHECK(rustsecp256k1_v0_10_0_keypair_create(CTX, &keypair, sk));
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, msg, msglen, &keypair, &extraparams));
    CHECK(rustsecp256k1_v0_10_0_memcmp_var(sig, expected_sig, 64) == 0);
    if (msglen == 32) {
        memset(sig, 0, 64);
        CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign32(CTX, sig, msg, &keypair, aux_rand));
        CHECK(rustsecp256k1_v0_10_0_memcmp_var(sig, expected_sig, 64) == 0);
    }

    CHECK(rustsecp256k1_v0_10_0_xonly_pubkey_parse(CTX, &pk_expected, pk_serialized));
    CHECK(rustsecp256k1_v0_10_0_keypair_xonly_pub(CTX, &pk, NULL, &keypair));
    CHECK(rustsecp256k1_v0_10_0_memcmp_var(&pk, &pk_expected, sizeof(pk)) == 0);
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig, msg, msglen, &pk));
}
...
static void test_schnorrsig_bip_vectors_check_verify(const unsigned char *pk_serialized, const unsigned char *msg, size_t msglen, const unsigned char *sig, int expected) {
    ...
    CHECK(rustsecp256k1_v0_10_0_xonly_pubkey_parse(CTX, &pk, pk_serialized));
    CHECK(expected == rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig, msg, msglen, &pk));
}
...
static void test_schnorrsig_bip_vectors(void) {
    ...
    }
    {
        ...
        rustsecp256k1_v0_10_0_xonly_pubkey pk_parsed;
        /* No need to check the signature of the test vector as parsing the pubkey already fails */
        CHECK(!rustsecp256k1_v0_10_0_xonly_pubkey_parse(CTX, &pk_parsed, pk));
    }
    {
        /* Test vector 6 */
        const unsigned char pk[32] = {
...
static void test_schnorrsig_sign(void) {
    ...
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &pk));
    /* Check that deprecated alias gives the same result */
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign(CTX, sig2, msg, &keypair, NULL) == 1);
    CHECK(rustsecp256k1_v0_10_0_memcmp_var(sig, sig2, sizeof(sig)) == 0);

    /* Test different nonce functions */
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypair, &extraparams) == 1);
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &pk));
    memset(sig, 1, sizeof(sig));
    extraparams.noncefp = nonce_function_failing;
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypair, &extraparams) == 0);
    CHECK(rustsecp256k1_v0_10_0_memcmp_var(sig, zeros64, sizeof(sig)) == 0);
    memset(&sig, 1, sizeof(sig));
    ...
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig, msg, sizeof(msg), &keypair, &extraparams) == 1);
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign32(CTX, sig2, msg, &keypair, extraparams.ndata) == 1);
    CHECK(rustsecp256k1_v0_10_0_memcmp_var(sig, sig2, sizeof(sig)) == 0);
}
...
static void test_schnorrsig_sign_verify(void) {
    ...
    /* Test overflowing s */
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign32(CTX, sig[0], msg[0], &keypair, NULL));
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig[0], msg[0], sizeof(msg[0]), &pk));
    ...
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign32(CTX, sig[0], msg[0], &keypair, NULL));
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig[0], msg[0], sizeof(msg[0]), &pk));
    rustsecp256k1_v0_10_0_scalar_set_b32(&s, &sig[0][32], NULL);
    rustsecp256k1_v0_10_0_scalar_negate(&s, &s);
    rustsecp256k1_v0_10_0_scalar_get_b32(&sig[0][32], &s);
    CHECK(!rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig[0], msg[0], sizeof(msg[0]), &pk));

    /* The empty message can be signed & verified */
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_sign_custom(CTX, sig[0], NULL, 0, &keypair, NULL) == 1);
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig[0], NULL, 0, &pk) == 1);

    {
        ...
        CHECK(rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig[0], msg_large, msglen, &pk) == 0);
    }
}
#undef N_SIGS
...
static void test_schnorrsig_taproot(void) {
    unsigned char sk[32];
    rustsecp256k1_v0_10_0_keypair keypair;
    rustsecp256k1_v0_10_0_xonly_pubkey internal_pk;
    unsigned char internal_pk_bytes[32];
    rustsecp256k1_v0_10_0_xonly_pubkey output_pk;
    ...
    CHECK(rustsecp256k1_v0_10_0_xonly_pubkey_serialize(CTX, tweak, &internal_pk) == 1);
    CHECK(rustsecp256k1_v0_10_0_keypair_xonly_tweak_add(CTX, &keypair, tweak) == 1);
    CHECK(rustsecp256k1_v0_10_0_keypair_xonly_pub(CTX, &output_pk, &pk_parity, &keypair) == 1);
    ...
    CHECK(rustsecp256k1_v0_10_0_schnorrsig_verify(CTX, sig, msg, sizeof(msg), &output_pk) == 1);

    /* Script spend */
    CHECK(rustsecp256k1_v0_10_0_xonly_pubkey_serialize(CTX, internal_pk_bytes, &internal_pk) == 1);
    /* Verify script spend */
    CHECK(rustsecp256k1_v0_10_0_xonly_pubkey_parse(CTX, &internal_pk, internal_pk_bytes) == 1);
    CHECK(rustsecp256k1_v0_10_0_xonly_pubkey_tweak_add_check(CTX, output_pk_bytes, pk_parity, &internal_pk, tweak) == 1);
}
