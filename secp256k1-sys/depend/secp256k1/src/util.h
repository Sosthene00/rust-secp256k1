...
typedef struct {
    ...
    const void* data;
} rustsecp256k1_v0_10_0_callback;

static SECP256K1_INLINE void rustsecp256k1_v0_10_0_callback_call(const rustsecp256k1_v0_10_0_callback * const cb, const char * const text) {
    cb->fn(text, (void*)cb->data);
}

#ifndef USE_EXTERNAL_DEFAULT_CALLBACKS
static void rustsecp256k1_v0_10_0_default_illegal_callback_fn(const char* str, void* data) {
    (void)data;
    fprintf(stderr, "[libsecp256k1] illegal argument: %s\n", str);
    abort();
}
static void rustsecp256k1_v0_10_0_default_error_callback_fn(const char* str, void* data) {
    (void)data;
    fprintf(stderr, "[libsecp256k1] internal consistency check failed: %s\n", str);
    abort();
}
#else
void rustsecp256k1_v0_10_0_default_illegal_callback_fn(const char* str, void* data);
void rustsecp256k1_v0_10_0_default_error_callback_fn(const char* str, void* data);
#endif

static const rustsecp256k1_v0_10_0_callback default_illegal_callback = {
    rustsecp256k1_v0_10_0_default_illegal_callback_fn,
    NULL
};

static const rustsecp256k1_v0_10_0_callback default_error_callback = {
...
static SECP256K1_INLINE void rustsecp256k1_v0_10_0_memczero(void *s, size_t len, int flag) {
...
static SECP256K1_INLINE void rustsecp256k1_v0_10_0_memzero_explicit(void *ptr, size_t len) {
#if defined(_MSC_VER)
 ...
 */
static SECP256K1_INLINE void rustsecp256k1_v0_10_0_memclear_explicit(void *ptr, size_t len) {
    /* The current implementation zeroes, but callers must not rely on this */
    rustsecp256k1_v0_10_0_memzero_explicit(ptr, len);
#ifdef VERIFY
 ...
 */
static SECP256K1_INLINE int rustsecp256k1_v0_10_0_memcmp_var(const void *s1, const void *s2, size_t n) {
 ...
 * Constant-time. */
static SECP256K1_INLINE int rustsecp256k1_v0_10_0_is_zero_array(const unsigned char *s, size_t len) {
    unsigned char acc = 0;
    int ret;
    size_t i;
    ...
    rustsecp256k1_v0_10_0_memclear_explicit(&acc, sizeof(acc));
    return ret;
}

/** If flag is true, set *r equal to *a; otherwise leave it. Constant-time.  Both *r and *a must be initialized and non-negative.*/
static SECP256K1_INLINE void rustsecp256k1_v0_10_0_int_cmov(int *r, const int *a, int flag) {
...
SECP256K1_INLINE static uint32_t rustsecp256k1_v0_10_0_read_be32(const unsigned char* p) {
...
SECP256K1_INLINE static void rustsecp256k1_v0_10_0_write_be32(unsigned char* p, uint32_t x) {
    p[3] = x;
    p[2] = x >>  8;
    p[1] = x >> 16;
    p[0] = x >> 24;
