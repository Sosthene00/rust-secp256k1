 ...
 *  rustsecp256k1_v0_10_0_context_create for creation of contexts and
 *  rustsecp256k1_v0_10_0_context_randomize for randomization.
 *
 ...
 *  rustsecp256k1_v0_10_0_context_set_error_callback as well as
 *  rustsecp256k1_v0_10_0_context_set_illegal_callback for details. Future library versions
 *  may use context objects for additional purposes.
 *
 *  A constructed context can safely be used from multiple threads
 *  simultaneously, but API calls that take a non-const pointer to a context
 *  need exclusive access to it. In particular this is the case for
 *  rustsecp256k1_v0_10_0_context_destroy, rustsecp256k1_v0_10_0_context_preallocated_destroy,
 *  and rustsecp256k1_v0_10_0_context_randomize.
 *
 ...
 */
typedef int (*rustsecp256k1_v0_10_0_nonce_function)(
 ...
 *  used in conjunction with rustsecp256k1_v0_10_0_selftest.
 *
 ...
 *  it is mentioned in its documentation. See rustsecp256k1_v0_10_0_context_create if you need a
 *  full context object that supports all functionality offered by the library.
 *
 *  It is highly recommended to call rustsecp256k1_v0_10_0_selftest before using this context.
 */

/** Deprecated alias for rustsecp256k1_v0_10_0_context_static. */

/** Perform basic self tests (to be used in conjunction with rustsecp256k1_v0_10_0_context_static)
 *
 ...
 *  binaries.
 *
 *  It is highly recommended to call this before using rustsecp256k1_v0_10_0_context_static.
 *  It is not necessary to call this function before using a context created with
 *  rustsecp256k1_v0_10_0_context_create (or rustsecp256k1_v0_10_0_context_preallocated_create), which will
 *  take care of performing the self tests.
 *
 *  If the tests fail, this function will call the default error handler to abort the
 *  program (see rustsecp256k1_v0_10_0_context_set_error_callback).
 */
SECP256K1_API void rustsecp256k1_v0_10_0_selftest(void);
 ...
 *  recommended to call rustsecp256k1_v0_10_0_context_randomize on the context before calling
 *  those API functions. This will provide enhanced protection against side-channel
 *  leakage, see rustsecp256k1_v0_10_0_context_randomize for details.
 *
 ...
 *  This function uses malloc to allocate memory. It is guaranteed that malloc is
 *  called at most once for every call of this function. If you need to avoid dynamic
 *  memory allocation entirely, see the functions in rustsecp256k1_v0_10_0_preallocated.h.
 *
 ...
 *
 *  The context to destroy must have been created using rustsecp256k1_v0_10_0_context_create
 *  or rustsecp256k1_v0_10_0_context_clone. If the context has instead been created using
 *  rustsecp256k1_v0_10_0_context_preallocated_create or rustsecp256k1_v0_10_0_context_preallocated_clone, the
 ...
 *   - void rustsecp256k1_v0_10_0_default_illegal_callback_fn(const char *message, void *data);
 *   - void rustsecp256k1_v0_10_0_default_error_callback_fn(const char *message, void *data);
 *  The library can call these default handlers even before a proper callback data
 *  pointer could have been set using rustsecp256k1_v0_10_0_context_set_illegal_callback or
 *  rustsecp256k1_v0_10_0_context_set_error_callback, e.g., when the creation of a context
 ...
 *
 *  See also rustsecp256k1_v0_10_0_context_set_error_callback.
 */
SECP256K1_API void rustsecp256k1_v0_10_0_context_set_illegal_callback(
 ...
 *  incorrect usage of the API (see rustsecp256k1_v0_10_0_context_set_illegal_callback
 ...
 *        data: the opaque pointer to pass to fun above, must be NULL for the default handler.
 *
 *  See also rustsecp256k1_v0_10_0_context_set_illegal_callback.
 */
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_ec_pubkey_parse(
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_ec_pubkey_cmp(
    const rustsecp256k1_v0_10_0_context *ctx,
    const rustsecp256k1_v0_10_0_pubkey *pubkey1,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_10_0_ecdsa_signature_parse_compact(
    const rustsecp256k1_v0_10_0_context *ctx,
 ...
 */
SECP256K1_API int rustsecp256k1_v0_10_0_ecdsa_signature_parse_der(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_ecdsa_signature *sig,
    const unsigned char *input,
    size_t inputlen
...
SECP256K1_API int rustsecp256k1_v0_10_0_ecdsa_signature_serialize_der(
    ...
    unsigned char *output,
    size_t *outputlen,
    const rustsecp256k1_v0_10_0_ecdsa_signature *sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4);
 ...
 * rule, apply rustsecp256k1_v0_10_0_ecdsa_signature_normalize to the signature prior to
 * verification, but be aware that doing so results in malleable signatures.
 *
 * For details, see the comments for that function.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_ecdsa_verify(
    const rustsecp256k1_v0_10_0_context *ctx,
    const rustsecp256k1_v0_10_0_ecdsa_signature *sig,
 ...
 *
 *  The rustsecp256k1_v0_10_0_ecdsa_sign function will by default create signatures in the
 *  lower-S form, and rustsecp256k1_v0_10_0_ecdsa_verify will not accept others. In case
 *  signatures come from a system that cannot enforce this property,
 *  rustsecp256k1_v0_10_0_ecdsa_signature_normalize must be called before verification.
 */
SECP256K1_API int rustsecp256k1_v0_10_0_ecdsa_signature_normalize(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_ecdsa_signature *sigout,
    const rustsecp256k1_v0_10_0_ecdsa_signature *sigin
...
/** A default safe nonce generation function (currently equal to rustsecp256k1_v0_10_0_nonce_function_rfc6979). */
 ...
 *                      rustsecp256k1_v0_10_0_nonce_function_default is used.
 *           ndata:     pointer to arbitrary data used by the nonce generation function
 *                      (can be NULL). If it is non-NULL and
 *                      rustsecp256k1_v0_10_0_nonce_function_default is used, then ndata must be a
 *                      pointer to 32-bytes of additional data.
 *
 * The created signature is always in lower-S form. See
 * rustsecp256k1_v0_10_0_ecdsa_signature_normalize for more details.
 */
SECP256K1_API int rustsecp256k1_v0_10_0_ecdsa_sign(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_ecdsa_signature *sig,
    const unsigned char *msghash32,
    const unsigned char *seckey,
    rustsecp256k1_v0_10_0_nonce_function noncefp,
    const void *ndata
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4);
 ...
 *  In:      seckey: pointer to a 32-byte secret key.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_ec_pubkey_create(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_pubkey *pubkey,
    const unsigned char *seckey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *           rustsecp256k1_v0_10_0_ec_seckey_verify. 1 otherwise
 *  Args:   ctx:    pointer to a context object
 *  In/Out: seckey: pointer to the 32-byte secret key to be negated. If the
 *                  secret key is invalid according to
 *                  rustsecp256k1_v0_10_0_ec_seckey_verify, this function returns 0 and
 ...
 */
SECP256K1_API int rustsecp256k1_v0_10_0_ec_pubkey_negate(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_pubkey *pubkey
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2);
 ...
 *                  invalid according to rustsecp256k1_v0_10_0_ec_seckey_verify, this
 *                  function returns 0. seckey will be set to some unspecified
 *                  value if this function returns 0.
 *  In:    tweak32: pointer to a 32-byte tweak, which must be valid according to
 *                  rustsecp256k1_v0_10_0_ec_seckey_verify or 32 zero bytes. For uniformly
 *                  random 32-byte tweaks, the chance of being invalid is
 *                  negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_ec_seckey_tweak_add(
    const rustsecp256k1_v0_10_0_context *ctx,
    unsigned char *seckey,
 ...
 *                  negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_ec_pubkey_tweak_add(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_pubkey *pubkey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *                  rustsecp256k1_v0_10_0_ec_seckey_verify, this function returns 0. For
 *                  uniformly random 32-byte arrays the chance of being invalid
 *                  is negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_ec_seckey_tweak_mul(
    const rustsecp256k1_v0_10_0_context *ctx,
    unsigned char *seckey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *                  is negligible (around 1 in 2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_ec_pubkey_tweak_mul(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_pubkey *pubkey,
    const unsigned char *tweak32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 * rustsecp256k1_v0_10_0_context_create or rustsecp256k1_v0_10_0_context_clone (or from the corresponding
 * functions in rustsecp256k1_v0_10_0_preallocated.h) before using these contexts to call API
 ...
 * context rustsecp256k1_v0_10_0_context_static is not supported.
 *
 * Currently, the random seed is mainly used for blinding multiplications of a
 * secret scalar with the elliptic curve base point. Multiplications of this
 * kind are performed by exactly those API functions which are documented to
 * require a context that is not rustsecp256k1_v0_10_0_context_static. As a rule of thumb,
 * these are all functions which take a secret key (or a keypair) as an input.
 * A notable exception to that rule is the ECDH module, which relies on a different
 * kind of elliptic curve point multiplication and thus does not benefit from
 * enhanced protection against side-channel leakage currently.
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_context_randomize(
    rustsecp256k1_v0_10_0_context *ctx,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1_v0_10_0_ec_pubkey_combine(
    const rustsecp256k1_v0_10_0_context *ctx,
    rustsecp256k1_v0_10_0_pubkey *out,
    const rustsecp256k1_v0_10_0_pubkey * const *ins,
    size_t n
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1_v0_10_0_tagged_sha256(
    const rustsecp256k1_v0_10_0_context *ctx,
